...
<?php } ?>
	...
	<script src="//localhost:8000/config/config.js?"></script>
	<script src="//localhost:8000/js/battledata.js?"></script>
	<script src="//localhost:8000/data/search-index.js?"></script>
	<script src="//localhost:8000/data/pokedex.js?"></script>
	<script src="//localhost:8000/data/teambuilder-tables.js?"></script>
	<script src="//localhost:8000/data/learnsets.js?"></script>
	<script src="//localhost:8000/data/moves.js?"></script>
	<script src="//localhost:8000/data/abilities.js?"></script>
	<script src="//localhost:8000/data/items.js?"></script>
	<script src="//localhost:8000/data/formats-data.js?"></script>
	<script src="//localhost:8000/data/typechart.js?"></script>
	<script src="//localhost:8000/data/aliases.js?"></script>
	<script src="//localhost:8000/js/battle-dex-search.js?"></script>
	<script src="//localhost:8000/js/search.js?"></script>
